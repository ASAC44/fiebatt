...
Replaces the self-hosted vision worker's SAM endpoint with a Modal function.
Deploy: `modal deploy apps/api/vision-worker/modal_worker.py`
Test:   `modal run apps/api/vision-worker/modal_worker.py`
