...
from app.ai.services.logger import get_stats, get_timeline, subscribe, unsubscribe
from app.ai.services.sam import is_available as vision_worker_available
...
async def ai_health():
    ...
    stats = get_stats()
    stats["vision_worker_available"] = await vision_worker_available()
    return stats
