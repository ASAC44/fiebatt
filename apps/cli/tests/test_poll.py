"""Tests for fiebatt_cli.poll — polling helpers for long-running jobs."""
...
from fiebatt_cli.poll import poll_job, poll_export, poll_propagation


@pytest.fixture()
def mock_client() -> MagicMock:
    """A mocked FiebattClient."""
    return MagicMock()
...
class TestPollJob:
    ...
    @patch("fiebatt_cli.poll.time.sleep", return_value=None)
