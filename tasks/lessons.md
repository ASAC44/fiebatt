...
- when the repo has a real frontend app, keep the app inside `apps/frontend/` and leave the repo root as orchestration/docs/config only. don't let convenience turn the root into a fake app directory again.
